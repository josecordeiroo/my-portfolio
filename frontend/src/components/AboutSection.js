    ...
    >
      <Description>
        ...
        <motion.p variants={fade}>
          ...
          developing with Javascript, dealing with the day-to-day tools that are
          highly sought after, such as Node.js, React, MongoDB and others. I am
          currently studying Systems Analysis and Development at Unisa
          University and looking for an internship in a company that can help me
          to develop myself more and more as a good professional.
        </motion.p>
        <button>Contact Me</button>
      </Description>

      <Image>
        <motion.img variants={photoAnimation}
